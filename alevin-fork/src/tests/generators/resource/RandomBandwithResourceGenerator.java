 ...
 */
@GeneratorParameter(
		parameters = { "Networks:Networks", "TR:Min_Bandwidth", "TR:Max_Bandwidth" }
		)
public class RandomBandwithResourceGenerator extends AbstractResourceGenerator<List<BandwidthResource>> {
